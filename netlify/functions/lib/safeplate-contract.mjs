export function fromSafeplateContract(r={}){
  return {
    ...
    establishment:r.facility?.name?{name:r.facility.name,identifier:r.facility.identifier||null,location:r.facility.location||null}:null,
    firmLocation:r.firmLocation||r.firm_location||r.facility?.location||null,
    hazard:r.hazard||'',
